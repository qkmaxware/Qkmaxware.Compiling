...
internal class DecOperator : UnaryOperator {

    public DecOperator(TextSection code, RegisterIndex result, RegisterIndex operand) : base(code, result, operand) {}
