...
/// </summary>
public class CEqS : FloatingPointEncodedInstruction, IAssemblyInstruction {
    ...
    public static bool TryDecodeBytecode(uint bytecode, out IBytecodeInstruction? decoded) {
        ...
        if (!word.Is(0..4, 2U)) return false;
    ...
    public static bool TryDecodeAssembly(Assembly.IdentifierToken opcode, List<Mips.Assembly.Token> args, out IAssemblyInstruction? decoded) {
        ...
        if (!IsAssemblyFormatDestLhsRhs<CEqS, Assembly.ScalarConstantToken, Assembly.RegisterToken, Assembly.RegisterToken>(opcode, args, out cc, out lhs, out rhs)) {
            decoded = null;
            return false;
        }
