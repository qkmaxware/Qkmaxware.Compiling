...
/// <summary>
/// Compare FPU registers for less than or equality (MIPS c.eq.s)
/// </summary>
public class CLeS : FloatingPointEncodedInstruction, IAssemblyInstruction {
    ...
    public static bool TryDecodeBytecode(uint bytecode, out IBytecodeInstruction? decoded) {
        ...
        if (!word.Is(0..4, 0xEU)) return false;
    ...
    public static bool TryDecodeAssembly(Assembly.IdentifierToken opcode, List<Mips.Assembly.Token> args, out IAssemblyInstruction? decoded) {
        ...
        if (!IsAssemblyFormatDestLhsRhs<CLeS, Assembly.ScalarConstantToken, Assembly.RegisterToken, Assembly.RegisterToken>(opcode, args, out cc, out lhs, out rhs)) {
            decoded = null;
            return false;
        }
