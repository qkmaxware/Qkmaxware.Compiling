...
/// </summary>
public class Lw : LoadStoreInstruction, Assembly.IAssemblyInstruction {
    ...
    /// </summary>
    /// <returns>description</returns>
    public override string InstructionDescription() => "Load a word from memory address $base + offset into $dest.";
