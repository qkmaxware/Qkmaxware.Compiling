...
/// </summary>
public class Lbu : LoadStoreInstruction, IAssemblyInstruction {
    ...
    /// </summary>
    /// <returns>description</returns>
    public string InstructionDescription() => "Load a byte from memory address $base + offset into $dest without preserving its sign.";
