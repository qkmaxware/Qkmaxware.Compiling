...
/// </summary>
public class Lhu : LoadStoreInstruction, Assembly.IAssemblyInstruction {
    ...
    /// </summary>
    /// <returns>description</returns>
    public override string InstructionDescription() => "Load a half-word from memory address $base + offset into $dest without preserving its sign.";
    ...
    public static bool TryDecodeAssembly(Assembly.IdentifierToken opcode, List<Mips.Assembly.Token> args, out Mips.Assembly.IAssemblyInstruction? decoded) {
        ...
        if (!IsAssemblyFormatDestOffsetBase<Lhu, Assembly.RegisterToken, Assembly.ScalarConstantToken, Assembly.RegisterToken>(opcode, args, out dest, out offset, out @base)) {
            decoded = null;
            return false;
        }
