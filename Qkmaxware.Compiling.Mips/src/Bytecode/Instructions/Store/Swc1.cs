...
/// </summary>
public class Swc1 : LoadStoreInstruction, IAssemblyInstruction {
    ...
    /// </summary>
    /// <returns>description</returns>
    public string InstructionDescription() => "Store a word into memory address $base + offset from FPU register $src.";
