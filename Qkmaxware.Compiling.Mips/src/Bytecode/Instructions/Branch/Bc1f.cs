...
/// <summary>
/// Branch on CO1 condition (MIPS bc1f)
/// </summary>
public class Bc1f : FloatingPointEncodedInstruction {
    ...
    /// </summary>
    /// <returns>description</returns>
    public string InstructionDescription() => "If the FPU condition flag at index cc is not set then move the PC by the given offset";
    ...
    public static bool TryDecodeBytecode(uint bytecode, out IBytecodeInstruction? decoded) {
        ...
        if (word.Decode(16..18) != 0) {
            return false; // Function 0
        }
