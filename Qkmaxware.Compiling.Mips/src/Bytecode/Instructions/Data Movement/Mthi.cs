...
/// </summary>
public class Mthi : MoveToInstruction, IAssemblyInstruction {
    ...
    public string AssemblyFormat() => $"{this.InstructionName()} $arg";

    /// <summary>
    /// Description of this instruction
    /// </summary>
    /// <returns>description</returns>
    public string InstructionDescription() => "Move a value stored in $arg into the special HI register";
