...
/// </summary>
public class Addu : ArithLogInstruction, Assembly.IAssemblyInstruction {
    ...
    public static bool TryDecodeAssembly(Assembly.IdentifierToken opcode, List<Mips.Assembly.Token> args, out Mips.Assembly.IAssemblyInstruction? decoded) {
        ...
        if (!IsAssemblyFormatDestLhsRhs<Addu, Assembly.RegisterToken, Assembly.RegisterToken, Assembly.RegisterToken>(opcode, args, out dest, out lhs, out rhs)) {
            decoded = null;
            return false;
        }
