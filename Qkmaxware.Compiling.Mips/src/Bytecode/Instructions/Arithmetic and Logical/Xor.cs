...
/// </summary>
public class Xor : ArithLogInstruction, Assembly.IAssemblyInstruction {
    public static readonly uint BinaryCode = 0b100110U;
    ...
    /// </summary>
    /// <returns>description</returns>
    public override string InstructionDescription() => "Compute $lhs xor $rhs and store the result in $dest.";
    ...
    public static bool TryDecodeAssembly(Assembly.IdentifierToken opcode, List<Mips.Assembly.Token> args, out Mips.Assembly.IAssemblyInstruction? decoded) {
        ...
        if (!IsAssemblyFormatDestLhsRhs<Xor, Assembly.RegisterToken, Assembly.RegisterToken, Assembly.RegisterToken>(opcode, args, out dest, out lhs, out rhs)) {
            decoded = null;
            return false;
        }
