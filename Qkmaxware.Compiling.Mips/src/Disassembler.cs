...
public class Disassembler {
    ...
    private static List<TryDecodeBytecode> decoders = new List<TryDecodeBytecode> {
        ...
        CvtSW.TryDecodeBytecode,
        CvtWS.TryDecodeBytecode,
        ...
        #endregion
        #region Branch
        Bc1f.TryDecodeBytecode,
        Bc1t.TryDecodeBytecode,
        ...
        #endregion 
        #region Comparison
        CEqS.TryDecodeBytecode,
        CLeS.TryDecodeBytecode,
        CLtS.TryDecodeBytecode,
