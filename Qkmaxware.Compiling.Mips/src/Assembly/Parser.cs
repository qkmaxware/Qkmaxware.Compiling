...
public class Parser {
    ...
    private static List<TryDecodeAssembly> decoders = new List<TryDecodeAssembly> {
        ...
        Bytecode.Instructions.CvtSW.TryDecodeAssembly,
        Bytecode.Instructions.CvtWS.TryDecodeAssembly,
        ...
        Bytecode.Instructions.NegS.TryDecodeAssembly,
        ...
        Bytecode.Instructions.SqrtS.TryDecodeAssembly,
        ...
        #endregion
        #region Branch
        Assembly.Instructions.Bc1f.TryDecodeAssembly,
        Assembly.Instructions.Bc1t.TryDecodeAssembly,
        ...
        #endregion
        #region Comparison
        Bytecode.Instructions.CEqS.TryDecodeAssembly,
        Bytecode.Instructions.CLeS.TryDecodeAssembly,
        Bytecode.Instructions.CLtS.TryDecodeAssembly,
